            ...
            <div class="col-md-12 register-container">
                <div class="card">
                    <div class="card-header text-center">
                        ...
                        <p class="mb-0" style="opacity: 0.9; font-size: 0.9rem;">Register to get started</p>
                    </div>
                    <div class="card-body">
                        ...
                        <?= form_open('register', ['id' => 'registerForm']) ?>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" placeholder="Enter your full name" value="<?= set_value('name') ?>" required>
                                <?= form_error('name', '<small class="text-danger d-flex align-items-center mt-1"><i class="bi bi-exclamation-circle me-1"></i>', '</small>') ?>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?= form_error('password_confirm', '<small class="text-danger d-flex align-items-center mt-1"><i class="bi bi-exclamation-circle me-1"></i>', '</small>') ?>
                            </div>
